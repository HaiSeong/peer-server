...
public interface UserDTOMapper {
        ...
        @Insert("INSERT INTO `nodam_db`.`UserDTO` (`id`, `name`, `major`, `college`, `studentNumber`, `grade`, `finding`, `state`) VALUES (#{id}, #{name}, #{major}, #{college}, #{studentNumber}, #{grade}, #{finding}, #{state})")
