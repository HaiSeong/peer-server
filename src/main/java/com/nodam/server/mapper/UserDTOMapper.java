...
public interface UserDTOMapper {
        ...
        @Insert("INSERT INTO `nodam_db`.`UserDTO` (`id`, `password`, `name`, `major`, `college`, `studentNumber`, `grade`, `finding`, `state`) VALUES (#{id}, #{password}, #{name}, #{major}, #{college}, #{studentNumber}, #{grade}, #{finding}, #{state})")
